...
export default function EnvironmentDashboard() {
  ...
  const cards: DisplayCard[] = readings
    ? [
        ...
        { label: "Wind speed", value: Math.round(readings.weather.wind_speed_10m).toString(), unit: "km/h", description: "Wind measured at 10 metres", tone: "sky" },
        ...
        { label: "Atmospheric pressure", value: Math.round(readings.weather.surface_pressure).toString(), unit: "hPa", description: "Local surface pressure", tone: "stone" },
        { label: "Noise", value: "—", description: "Requires a calibrated local sensor", tone: "ink" },
    ...
    : [
        ...
        { label: "Atmospheric pressure", value: "—", description: "Waiting for local conditions", tone: "stone" },
        { label: "Noise", value: "—", description: "Requires a calibrated local sensor", tone: "ink" },
